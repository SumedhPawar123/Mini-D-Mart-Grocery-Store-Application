      ...
      <div className="flex items-center gap-2 overflow-x-auto pb-3 mb-4 scrollbar-none">
        {["all", "active", "delivered", "cancelled"].map((tab) => (
          <button
            ...
            className={`px-3 py-1.5 rounded-full text-xs font-semibold capitalize transition ${statusFilter === tab
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          className={`text-[10px] font-semibold uppercase px-2 py-0.5 rounded-full border ${statusColors[o.status] || "bg-gray-100 text-gray-700"
                            }`}
                        >
