      ...
      >
        ...
        <div className="block md:hidden w-full">
          {isRegister ? (
            ...
            /* ================= MOBILE LOGIN ================= */
            <div className="w-full px-5 py-10 sm:px-8 sm:py-12">
              <div className="w-full max-w-md mx-auto">
        ...
        {/* =====================================================
            ...
            >= 768px
        ===================================================== */}
        <div className="hidden md:block h-[650px] lg:h-[680px]">
          ...
          >
            <div className="w-full max-w-md">
              ...
              {/* Logo */}
              <div className="flex justify-center mb-4">
                <div className="w-12 h-12 bg-brand text-white rounded-2xl flex items-center justify-center shadow-lg">
                  <ShoppingCart size={24} />
                </div>
              </div>
          ...
          <div
            className={`
              ...
              ${
                isRegister
                  ? "left-0 rounded-r-[100px] lg:rounded-r-[120px]"
                  : "left-1/2 rounded-l-[100px] lg:rounded-l-[120px]"
              }
            `}
          >
            <div className="text-center max-w-sm">
              ...
              {/* Icon */}
              <div className="text-6xl lg:text-7xl mb-6">
                {isRegister ? "🛒" : "🥦"}
              </div>
